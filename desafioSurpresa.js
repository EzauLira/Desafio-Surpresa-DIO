        ...
        const statusPokemons = [
            ...
            ["Nome: DRAGONITE2, " + "level: 5, " + "Sexo: Feminino, " + "Pontos de vida: 24" + "Pokemon Cadastrado com sucesso!"],
            ["Nome: DAGONITE3, " + "level: 5, " + "Sexo: Feminino, " + "Pontos de vida: 24" + "Pokemon Cadastrado com sucesso!"],
